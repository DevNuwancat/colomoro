  ...
  <section class="mx-4 my-6">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-primary font-bold text-gray-900 mb-4">Contact Us</h1>
        <div class="w-20 h-1 bg-green-500 mx-auto rounded-full"></div>
        <p class="text-gray-600 mt-4">We'd love to hear from you. Get in touch with us!</p>
      </div>

      <div class="grid md:grid-cols-2 gap-6">
        
        <!-- Contact Information -->
        <div class="bg-background border border-gray-200 rounded-xl p-8 space-y-6">
          ...
          <div class="flex items-start gap-4 group">
            ...
            <div>
              ...
              <a href="https://wa.me/94123456789" class="text-green-600 hover:text-green-700 transition-colors">
                +94 12 345 6789
              </a>
            </div>
          </div>
        -->
          ...
          <div class="flex items-start gap-4 group">
            ...
            <div>
              ...
              <a href="mailto:info@colomoro.com" class="text-blue-600 hover:text-blue-700 transition-colors">
                info@colomoro.com
              </a>
            </div>
          </div>
          ...
          <div class="pt-4 border-t border-gray-200">
            ...
            <div class="flex gap-3">
              <a href="https://www.facebook.com/share/17V9P6sxQd/" 
                 class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-700 text-white hover:scale-110 transition-transform duration-200">
        ...
        <!-- Contact Form -->
        <div class="bg-background border border-gray-200 rounded-xl p-8">
          
          <h2 class="text-2xl font-primary font-bold text-gray-900 mb-6">Send Us a Message</h2>
          ...
          <form class="space-y-4">
            ...
            <button 
              type="submit" 
              class="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
            >
              Send Message
            </button>
